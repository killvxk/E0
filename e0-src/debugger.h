...
public:
  ...
  std::map<uint64_t, std::map<uint64_t, std::string> > symbols;
  void LoadModuleSymbols(void *base_address);
...
protected:
  ...
  virtual void OnModuleLoaded(void *module, char *module_name, char *path);
  ...
  virtual void OnInputpoint();
  virtual void OnStoppoint();
  virtual void OnUnhandledException();
  virtual void OnHardwareBreakpoint();
  virtual void OnSingleStep();
  virtual bool OnMemAccess();
  virtual bool OnWatchpoint();
  virtual void LogSuspendCount();
